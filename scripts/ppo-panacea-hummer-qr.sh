...
ACCURACY_MODEL_NAME_OR_PATH="output/rm_qr_accuracy_PKU-Alignment/alpaca-8b-reproduced-llama-3"
CONCISENESS_MODEL_NAME_OR_PATH="output/rm_qr_conciseness_PKU-Alignment/alpaca-8b-reproduced-llama-3"
DEPTH_MODEL_NAME_OR_PATH="output/rm_qr_depth_PKU-Alignment/alpaca-8b-reproduced-llama-3"
EMPATHY_MODEL_NAME_OR_PATH="output/rm_qr_empathy_PKU-Alignment/alpaca-8b-reproduced-llama-3"
SPECIFICITY_MODEL_NAME_OR_PATH="output/rm_qr_specificity_PKU-Alignment/alpaca-8b-reproduced-llama-3"
TONE_MODEL_NAME_OR_PATH="output/rm_qr_tone_PKU-Alignment/alpaca-8b-reproduced-llama-3"
...
EPOCHS=2
UPDATE_ITERS=1
PER_DEVICE_PROMPT_BATCH_SIZE=16    # 128 → 64: 메모리 누적 방지
PER_DEVICE_TRAIN_BATCH_SIZE=16     # 128 → 64: CUDA 타임아웃 해결
PER_DEVICE_EVAL_BATCH_SIZE=16      # 128 → 64: 평가 메모리 절감
